...
export function LoginForm({
  ...
  handleCredentialsLogin: propHandleCredentialsLogin,
  ...
  const handleCredentialsLogin = propHandleCredentialsLogin || (async (e: React.FormEvent) => {
    e.preventDefault()
  ...
  if (status === "loading") {
    return (
      <div className={cn("flex flex-col gap-6 items-center justify-center", className)}>
  ...
  return (
    <form className={cn("flex flex-col gap-6", className)} onSubmit={handleCredentialsLogin} {...props}>
